...
const pluginConfig = {
    name: 'todubai',
    alias: ['dubai', 'jadiorangkaya', 'sultan'],
    category: 'ai',
    description: 'Ubah foto kamu jadi ala-ala sultan Dubai',
    usage: '.todubai (reply/caption foto)',
    example: '.todubai',
    isOwner: false,
    isPremium: false,
    isGroup: false,
...
const TODUBAI_URL = 'https://api-faa.my.id/faa/todubai?url='
...
async function handler(m, { sock }) {
    ...
    if (!fromQuoted && !fromDirect) {
        return m.reply(
            `👳‍♂️ *ᴛᴏ ᴅᴜʙᴀɪ* 👳‍♂️\n\n` +
            `> Mau liat muka Tuan pas jadi Sultan Dubai kaya raya? 💸\n` +
    ...
    try {
        ...
        const res = await axios.get(`${TODUBAI_URL}${encodeURIComponent(imageUrl)}`, {
        ...
        await sock.sendMessage(m.chat, {
            image: resultBuffer,
            caption: '✨ *ꜱʜᴀʟᴀᴍ ᴛᴜᴀɴ!* ✨\n\nꜰᴏᴛᴏ ᴛᴜᴀɴ ᴜᴅᴀʜ ʙᴇʀᴜʙᴀʜ ᴊᴀᴅɪ ꜱᴜʟᴛᴀɴ ᴅᴜʙᴀɪ ʏᴀɴɢ ᴍᴇɢᴀʜ ᴅᴀɴ ᴘᴇɴᴜʜ ᴘᴇꜱᴏɴᴀ! ᴊᴀɴɢᴀɴ ʟᴜᴘᴀ ʙᴀɢɪ-ʙᴀɢɪ ᴇᴍᴀꜱ ɴʏᴀ ʏᴀ ᴛᴜᴀɴ~ 👑💵'
        }, { quoted: m })
