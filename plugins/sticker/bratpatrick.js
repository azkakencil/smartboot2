...
const pluginConfig = {
    name: 'bratpatrick',
    alias: ['bpatrick', 'patrickbrat'],
    category: 'sticker',
    description: 'Brat patrick jadi sticker (no crop)',
    usage: '.bratpatrick <teks>',
    example: '.bratpatrick Halo semuanya',
    cooldown: 10,
    isEnabled: true
}
...
.${pluginConfig.name} Halo semuanya`
        ...
        const res = await axios.get(
            'https://api-nanzz.my.id/docs/api/maker/brat/brat-patrick.php',
            {
                params: { text },
