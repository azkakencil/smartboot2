...
const pluginConfig = {
    name: 'bratprabowo',
    alias: ['bprabowo', 'prabowobrat'],
    category: 'sticker',
    description: 'Brat prabowo jadi sticker (no crop)',
    usage: '.bratprabowo <teks>',
    example: '.bratprabowo Halo semuanya',
    cooldown: 10,
    isEnabled: true
}
...
.${pluginConfig.name} Halo semuanya`
        ...
        const res = await axios.get(
            'https://api-nanzz.my.id/docs/api/maker/brat/brat-prabowo.php',
            {
                params: { text },
